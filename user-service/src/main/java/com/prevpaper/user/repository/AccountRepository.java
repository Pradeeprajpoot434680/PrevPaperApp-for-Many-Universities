...
public interface AccountRepository extends JpaRepository<Account, UUID> {
    ...
    @Query("SELECT a FROM Account a JOIN FETCH a.user WHERE a.programId = :programId AND a.batchYear = :batchYear")
    List<Account> findByProgramIdAndBatchYearWithProfile(
